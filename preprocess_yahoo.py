...
v = [x for x, y in vocab.items() if y >= 30]
...
pickle.dump([train_x, val_x, test_x, train_text, val_text, test_text, train_y, val_y, test_y, wordtoix, ixtoword], open("yahoo4char.p", "wb"))
